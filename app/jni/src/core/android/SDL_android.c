...
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(JNIEnv *env, jclass cls, jstring library, jstring function, jobject array)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() library_file:%s",library_file);
    ...
    if (!library_handle) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() library_name:%s",library_name);
    ...
    if (library_handle) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() function_name:%s",function_name);
        SDL_main = (SDL_main_func)dlsym(library_handle, function_name);
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() SDL_main:%s",SDL_main);
        if (SDL_main) {
            int i;
            int argc;
            int len;
